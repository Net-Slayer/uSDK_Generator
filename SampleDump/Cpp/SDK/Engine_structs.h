...
{
	unsigned char                                      UnknownData_6EEA[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X67Z[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_48MQ[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_12K6[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CE27[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7OTW[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1EHY[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData_GWWV[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6XT2[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XMBH[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSimulatedRootMotionReplicatedMove
{
	...
	unsigned char                                      UnknownData_L3RK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData_M77Q[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownData_VBE9[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyState
{
	...
	unsigned char                                      UnknownData_XZ5K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FR11[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FForceFeedbackParameters
{
	...
	unsigned char                                      UnknownData_2V9T[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (PADDING)
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData_4IQR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPredictProjectilePathResult
{
	...
	unsigned char                                      UnknownData_AG2J[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      UnknownData_ONBJ[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IEYM[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H7I8[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6LC3[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
struct FActiveHapticFeedbackEffect
{
	...
	unsigned char                                      UnknownData_42PQ[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FImportanceTexture
{
	...
	unsigned char                                      UnknownData_L741[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WM7O[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AFCD[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MPR5[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VC6N[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInstancedStaticMeshComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_LM3M[0x20];                                    // 0x0110(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6GPI[0xC];                                     // 0x0134(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MYLA[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OZAU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIntegralCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_950T[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubTrackGroup
{
	...
	unsigned char                                      UnknownData_ASDH[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSupportedSubTrackInfo
{
	...
	unsigned char                                      UnknownData_I25Q[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FDrawToRenderTargetContext
{
	...
	unsigned char                                      UnknownData_TGZH[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0L7R[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMaterialProxySettings
{
	...
	unsigned char                                      UnknownData_PHIE[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      UnknownData_TKX6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJA4[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D6CZ[0x2];                                     // 0x012A(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6439[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FDynamicTextureInstance : public FStreamableTextureInstance
{
	...
	unsigned char                                      UnknownData_C6P3[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3WS3[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RR5E[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FBatchedPoint
{
	...
	unsigned char                                      UnknownData_XWVU[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FBatchedLine
{
	...
	unsigned char                                      UnknownData_J7YZ[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData_H4M0[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParameterGroupData
{
	...
	unsigned char                                      UnknownData_RIEM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FFunctionExpressionInput
{
	...
	unsigned char                                      UnknownData_0FTZ[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (PADDING)
...
struct FScalarParameterAtlasInstanceData
{
	...
	unsigned char                                      UnknownData_NZE4[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData_5EX6[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FMeshInstancingSettings
{
	...
	unsigned char                                      UnknownData_24OY[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      UnknownData_O5HQ[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FBasedMovementInfo
{
	...
	unsigned char                                      UnknownData_33JE[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
struct FRootMotionMovementParams
{
	...
	unsigned char                                      UnknownData_L0GV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WH7V[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData_SGO1[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FWalkableSlopeOverride
{
	...
	unsigned char                                      UnknownData_KEQQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HEC3[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y8A1[0x6];                                     // 0x0000(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WSFP[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2ZWB[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P2OR : 1;                                      // 0x000C(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_IE6R : 2;                                      // 0x000E(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_0JG7[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_21UT[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_USRD[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NMTK[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1IZQ[0x40];                                    // 0x00D0(0x0040) MISSED OFFSET (PADDING)
...
struct FSkelMeshComponentLODInfo
{
	...
	unsigned char                                      UnknownData_FZVY[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FSingleAnimationPlayData
{
	...
	unsigned char                                      UnknownData_DTHG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HDCT[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2JOM[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_70PY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CKXV[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_HSJF[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8X40[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MJDQ[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NNE2[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TrackIndex;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XP0V[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData_OLBH[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G10B[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRealCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_UX69[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
struct FRichCurveKey
{
	...
	unsigned char                                      UnknownData_4XAA[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_386K[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRB3[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JR5E[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttenuationSubmixSendSettings
{
	...
	unsigned char                                      UnknownData_ED09[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
	...
	unsigned char                                      UnknownData_FSQP[0x1];                                     // 0x00B3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XE4U[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JWVO[0x4];                                     // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActiveForceFeedbackEffect
{
	...
	unsigned char                                      UnknownData_WO5X[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5HG9[0x17];                                    // 0x0001(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChannelDefinition
{
	...
	unsigned char                                      UnknownData_N9AO[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FRigTransformConstraint
{
	...
	unsigned char                                      UnknownData_0BUR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassProperties
{
	...
	unsigned char                                      UnknownData_TPD1[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WHS1[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CULT[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AI65[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScreenMessageString
{
	...
	unsigned char                                      UnknownData_TGIJ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownData_2OVS[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      UnknownData_93RN[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNamedNetDriver
{
	...
	unsigned char                                      UnknownData_WIJW[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XG0E[0xD0];                                    // 0x0000(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VVZV[0x10];                                    // 0x01B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6S1I[0x18];                                    // 0x01D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YKFO[0x50];                                    // 0x0230(0x0050) MISSED OFFSET (PADDING)
...
struct FExposureSettings
{
	...
	unsigned char                                      UnknownData_W3W6[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q9L1[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FHLODProxyMesh
{
	...
	unsigned char                                      UnknownData_CY47[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintComponentChangedPropertyInfo
{
	...
	unsigned char                                      UnknownData_A2SW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintCookedComponentInstancingData
{
	...
	unsigned char                                      UnknownData_LQUE[0x11];                                    // 0x0010(0x0011) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MZM4[0x26];                                    // 0x0022(0x0026) MISSED OFFSET (PADDING)
...
struct FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_YDWE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_TYJL[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_HHTK[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedKeyToActionInfo
{
	...
	unsigned char                                      UnknownData_WO4I[0x68];                                    // 0x0008(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D92S[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BWF8[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GOD8[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FInputAxisProperties
{
	...
	unsigned char                                      UnknownData_GIO4[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_OBJA[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialParameterInfo
{
	...
	unsigned char                                      UnknownData_XRE9[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialCachedExpressionData
{
	...
	unsigned char                                      UnknownData_JZ5J[0x7];                                     // 0x0221(0x0007) MISSED OFFSET (PADDING)
...
struct FMaterialSpriteElement
{
	...
	unsigned char                                      UnknownData_B2JF[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3O8F[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDistributionLookupTable
{
	...
	unsigned char                                      UnknownData_H3WT[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegionBoneFilter
{
	...
	unsigned char                                      UnknownData_4LTW[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegion
{
	...
	unsigned char                                      UnknownData_BP1P[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_D6WL[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseLinkBase
{
	...
	unsigned char                                      UnknownData_N894[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J36Q[0x6E0];                                   // 0x0000(0x06E0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W263[0x150];                                   // 0x06E0(0x0150) MISSED OFFSET (PADDING)
...
struct FMeshSectionInfo
{
	...
	unsigned char                                      UnknownData_RBA0[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (PADDING)
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_S2K8[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QWNK[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshSourceModel
{
	...
	unsigned char                                      UnknownData_4W41[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_QYWH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R467[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZZL7[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EJ9T[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2LYM[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshVertexColorLODData
{
	...
	unsigned char                                      UnknownData_TEJ0[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshComponentInstanceData : public FPrimitiveComponentInstanceData
{
	...
	unsigned char                                      UnknownData_Q18O[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JPGC[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_D4N6[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOrbitOptions
{
	...
	unsigned char                                      UnknownData_XBUO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FKShapeElem
{
	unsigned char                                      UnknownData_SEVG[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RLDF[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZTD4[0x17];                                    // 0x0019(0x0017) MISSED OFFSET (PADDING)
...
struct FKConvexElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_PMI5[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0070(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_JZOK[0x10];                                    // 0x00A0(0x0010) MISSED OFFSET (PADDING)
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData_BYAC[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      UnknownData_A5HF[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FForceFeedbackChannelDetails
{
	...
	unsigned char                                      UnknownData_3MIU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownData_I6C4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpControlPoint
{
	...
	unsigned char                                      UnknownData_U3PC[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RFHY[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DQ4Z[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XGOK[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MIQ6[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      UnknownData_DE02[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZRYN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SVUB[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EQOO[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C8H3[0x28];                                    // 0x0010(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QQP6[0x60];                                    // 0x0040(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMulticastRecordOptions
{
	...
	unsigned char                                      UnknownData_QRC8[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData_WLNH[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JU72[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GOVI[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2VX0[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GJ9F[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (PADDING)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      UnknownData_9Z0G[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6HBX[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_KVHR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPSCPoolElem
{
	...
	unsigned char                                      UnknownData_S3UC[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FPSCPool
{
	...
	unsigned char                                      UnknownData_R3IB[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FWorldPSCPool
{
	...
	unsigned char                                      UnknownData_DF8T[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FFindFloorResult
{
	...
	unsigned char                                      UnknownData_U7Q2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedStateExitTransition
{
	...
	unsigned char                                      UnknownData_U5PN[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedAnimationState
{
	...
	unsigned char                                      UnknownData_ZQIS[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GK9A[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData_17MC[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AKI0[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData_BVYD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedBlendable
{
	...
	unsigned char                                      UnknownData_W9BF[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      UnknownData_95DM[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6SFH[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LQXK[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H6UY[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y4KI[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NJN8[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3KFO[0x3];                                     // 0x0315(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LL3S[0x7];                                     // 0x0319(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5JRU[0x3];                                     // 0x0411(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y52X[0x3];                                     // 0x043D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y9Q7[0x3];                                     // 0x0459(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W13B[0x3];                                     // 0x04E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N5IZ[0x1];                                     // 0x0507(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SQSB[0x2];                                     // 0x0516(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3I4W[0x4];                                     // 0x052C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMinimalViewInfo
{
	...
	unsigned char                                      UnknownData_3CW4[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PX6N[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EXRA[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AUWV[0x48];                                    // 0x0588(0x0048) MISSED OFFSET (PADDING)
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData_SAN7[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZFG1[0x8];                                     // 0x05E8(0x0008) MISSED OFFSET (PADDING)
...
struct FDebugTextInfo
{
	...
	unsigned char                                      UnknownData_VO88[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WJJU[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KTGU[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B1J3[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FLightmassMaterialInterfaceSettings
{
	...
	unsigned char                                      UnknownData_3CE5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_S9NB[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FStaticTerrainLayerWeightParameter : public FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_HIHS[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FSoundConcurrencySettings
{
	...
	unsigned char                                      UnknownData_2P6U[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SE0F[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SXNG[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKBoxElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_FRAF[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKTaperedCapsuleElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_5MUG[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKAggregateGeom
{
	...
	unsigned char                                      UnknownData_OMUG[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FCustomInput
{
	...
	unsigned char                                      UnknownData_IQ5Q[0x8];                                     // 0x0014(0x0008) MISSED OFFSET (PADDING)
...
struct FCameraCacheEntry
{
	...
	unsigned char                                      UnknownData_9DVJ[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEditorImportExportTestDefinition
{
	...
	unsigned char                                      UnknownData_NKR9[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBeamModifierOptions
{
	...
	unsigned char                                      UnknownData_LK4B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      UnknownData_K7YY[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData_KN6D[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3AWB[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DJCM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGPUSpriteLocalVectorFieldInfo
{
	...
	unsigned char                                      UnknownData_C6DZ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H5PM[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
struct FGPUSpriteEmitterInfo
{
	...
	unsigned char                                      UnknownData_O6QN[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P96N[0x2];                                     // 0x016A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bEnableCollision : 1;                                      // 0x016C(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_T6VG[0x3];                                     // 0x016D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5HZZ[0x3];                                     // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bRemoveHMDRoll : 1;                                        // 0x0174(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JJA4[0x3];                                     // 0x0175(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OSR8[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData_5P1T[0x2];                                     // 0x0146(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EINY[0x3];                                     // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4HKL[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B0FO[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DNZN[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData_ODNG[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTHY[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAlphaBlend
{
	...
	unsigned char                                      UnknownData_RKSU[0x18];                                    // 0x000C(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OUZW[0xB];                                     // 0x0025(0x000B) MISSED OFFSET (PADDING)
...
struct FInputAlphaBoolBlend
{
	...
	unsigned char                                      UnknownData_NI0V[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ISHR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4HND[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J9O8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDamageEvent
{
	unsigned char                                      UnknownData_HR2G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_FWA4[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J64M[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseSnapshot
{
	...
	unsigned char                                      UnknownData_NYXB[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FName                                       Name;                                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_W3FJ[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GN26[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FRootMotionFinishVelocitySettings
{
	...
	unsigned char                                      UnknownData_MZT5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_E3XN[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VR9V[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RSMH[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VZTQ[0x4];                                     // 0x0094(0x0004) Fix Super Size
...
struct FRootMotionSource_JumpForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_6DR1[0x3];                                     // 0x00AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YSQN[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FRootMotionSource_MoveToDynamicForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_6HDU[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_MoveToForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_DO3D[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_KW2D[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G00B[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FFontParameterValue
{
	...
	unsigned char                                      UnknownData_X5MO[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FMarkerSyncData
{
	...
	unsigned char                                      UnknownData_HVVS[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FBoneFilter
{
	...
	unsigned char                                      UnknownData_JWXF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_ZOY5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TWDO[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BATU[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YVGD[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODGroupSettings
{
	...
	unsigned char                                      UnknownData_83P0[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4TEQ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WTY0[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSubsurfaceProfileStruct
{
	...
	unsigned char                                      UnknownData_CTRL[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData_99KB[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimelineFloatTrack
{
	...
	unsigned char                                      UnknownData_SXCN[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimelineLinearColorTrack
{
	...
	unsigned char                                      UnknownData_VVOV[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimeline
{
	...
	unsigned char                                      UnknownData_GXUE[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CT4J[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (PADDING)
...
struct FTTTrackBase
{
	unsigned char                                      UnknownData_IQWN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SU7X[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FVirtualTextureSpacePoolConfig
{
	...
	unsigned char                                      UnknownData_WBDR[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticSwitchParameter : public FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_HW98[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDrive
{
	...
	unsigned char                                      UnknownData_U3AQ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearDriveConstraint
{
	...
	unsigned char                                      UnknownData_91MP[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FSimpleCurve : public FRealCurve
{
	...
	unsigned char                                      UnknownData_KJ2X[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothingAssetData_Legacy
{
	...
	unsigned char                                      UnknownData_OV50[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FClothPhysicsProperties_Legacy              PhysicsProperties;                                         // 0x001C(0x0050) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_L5UF[0xC];                                     // 0x006C(0x000C) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshClothBuildParams
{
	...
	unsigned char                                      UnknownData_7KJ6[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_59V0[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneMirrorExport
{
	...
	unsigned char                                      UnknownData_3BAD[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SQ2O[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L6FH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0J0Z[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData_0MZI[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphTerminalType
{
	...
	unsigned char                                      UnknownData_GMZP[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData_A3DR[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownData_CQZ4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      UnknownData_58PE[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BQWK[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MSS5[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CFJM[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QDGP[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AGQA[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DRXK[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FInputAxisKeyMapping
{
	...
	unsigned char                                      UnknownData_EULU[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSubmixSendInfo
{
	...
	unsigned char                                      UnknownData_FT7O[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0GW8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_SingleNode : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_U1HO[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData_UN87[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSourceBusSendInfo
{
	...
	unsigned char                                      UnknownData_83P8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	float                                              MinSendDistance;                                           // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                              MaxSendDistance;                                           // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I3QQ[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeFloatCurve                          CustomSendLevelCurve;                                      // 0x0028(0x0088) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
struct FSubtitleCue
{
	...
	unsigned char                                      UnknownData_R1S1[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInterpolationParameter
{
	...
	unsigned char                                      UnknownData_0UFJ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	struct FName                                       BoneName;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KQIG[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FBlendParameter
{
	...
	unsigned char                                      UnknownData_L5T1[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData_877Z[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData_WL6G[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimBlueprintFunction
{
	...
	unsigned char                                      UnknownData_5SZI[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R5K3[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O7P1[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FSmartName
{
	...
	unsigned char                                      UnknownData_VQR7[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimSegment
{
	...
	unsigned char                                      UnknownData_2013[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_WYV0[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBranchingPointMarker
{
	...
	unsigned char                                      UnknownData_D9JB[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurve
{
	...
	unsigned char                                      UnknownData_JCGZ[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetRules
{
	...
	unsigned char                                      UnknownData_QMAG[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      UnknownData_G65I[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4BTY[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R99J[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAudioQualitySettings
{
	...
	unsigned char                                      UnknownData_4B8L[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FReverbSettings
{
	...
	unsigned char                                      UnknownData_J07K[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteriorSettings
{
	...
	unsigned char                                      UnknownData_3GEJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavAgentSelector
{
	...
	unsigned char                                      UnknownData_WL6C[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData_NF67[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I9YN[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q50C[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7GXQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FSoundWaveSpectralTimeData
{
	...
	unsigned char                                      UnknownData_FQNI[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FNode
{
	...
	unsigned char                                      UnknownData_QFZN[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
struct FVirtualTextureBuildSettings
{
	...
	unsigned char                                      UnknownData_VSJ0[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FMeshUVChannelInfo
{
	...
	unsigned char                                      UnknownData_LT5X[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneMirrorInfo
{
	...
	unsigned char                                      UnknownData_RRKO[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshBuildSettings
{
	...
	unsigned char                                      bBuildAdjacencyBuffer : 1;                                 // 0x0000(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Q4I6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      UnknownData_E8ED[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QOLE[0x6];                                     // 0x00B2(0x0006) MISSED OFFSET (PADDING)
...
struct FSkinWeightProfileInfo
{
	...
	unsigned char                                      UnknownData_OHJD[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData_G4GZ[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D14H[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S5GT[0xA8];                                    // 0x00A8(0x00A8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4OTF[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YYUW[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FEditedDocumentInfo
{
	...
	unsigned char                                      UnknownData_3HMW[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData_QPLW[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_PLE9[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCompilerNativizationOptions
{
	...
	unsigned char                                      UnknownData_S0SH[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventGraphFastCallPair
{
	...
	unsigned char                                      UnknownData_0MNY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L7E1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VN8F[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IBZ5[0x190];                                   // 0x0000(0x0190) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2LE9[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RUJY[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PH2H[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1GAD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCachedAnimTransitionData
{
	...
	unsigned char                                      UnknownData_6MPM[0xC];                                     // 0x0018(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimRelevancyData
{
	...
	unsigned char                                      UnknownData_L6K5[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimAssetPlayerData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CVAC[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QFON[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      UnknownData_YLJZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VW4P[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FBoolTrackKey
{
	...
	unsigned char                                      UnknownData_3J1W[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FPrimitiveMaterialRef
{
	...
	unsigned char                                      UnknownData_TBV2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownData_F2YL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FToggleTrackKey
{
	...
	unsigned char                                      UnknownData_UYUT[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FVisibilityTrackKey
{
	...
	unsigned char                                      UnknownData_1T0Q[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FLayerActorStats
{
	...
	unsigned char                                      UnknownData_EDVD[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData_SSB4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PY4H[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhysicalAnimationData
{
	...
	unsigned char                                      UnknownData_ULSK[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_DIW7[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_DP2L[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FConeConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_2MO8[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FTwistConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_4TDN[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FAngularDriveConstraint
{
	...
	unsigned char                                      UnknownData_TWW6[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintProfileProperties
{
	...
	unsigned char                                      UnknownData_HE2Q[0x3];                                     // 0x0101(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0BBM[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y5LF[0x7];                                     // 0x0085(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FConstraintProfileProperties                ProfileInstance;                                           // 0x008C(0x0104) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2Y6B[0x28];                                    // 0x0190(0x0028) MISSED OFFSET (PADDING)
...
struct FNodeItem
{
	...
	unsigned char                                      UnknownData_FJFI[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
struct FSourceEffectChainEntry
{
	...
	unsigned char                                      UnknownData_F6KB[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FSoundGroup
{
	...
	unsigned char                                      UnknownData_RKJU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IX6Q[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData_BL0Y[0x1];                                     // 0x009F(0x0001) MISSED OFFSET (PADDING)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData_GNLU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFormatArgumentData
{
	...
	unsigned char                                      UnknownData_7I80[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5K02[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VDIO[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData_Y7PR[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_542O[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPrimaryAssetRulesCustomOverride
{
	...
	unsigned char                                      UnknownData_61PU[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Q8I2[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FModulatorContinuousParams
{
	...
	unsigned char                                      UnknownData_E2MB[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FEditorMapPerformanceTestDefinition
{
	...
	unsigned char                                      UnknownData_THJR[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      UnknownData_ZGQI[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKey                                        Key;                                                       // 0x0010(0x0018) (Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FRootMotionSource_RadialForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_SSR7[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_POXX[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KNCK[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_ConstantForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_9R74[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCameraExposureSettings
{
	...
	unsigned char                                      UnknownData_1P9I[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I2GW[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FConvolutionBloomSettings
{
	...
	unsigned char                                      UnknownData_NJRN[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FLensBloomSettings
{
	...
	unsigned char                                      UnknownData_NOSC[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YIY5[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FBandwidthTestGenerator
{
	...
	unsigned char                                      UnknownData_0JUL[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FBoneNode
{
	...
	unsigned char                                      UnknownData_2T3H[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KN6J[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FCollisionResponseTemplate
{
	...
	unsigned char                                      UnknownData_8YNI[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JID3[0x21];                                    // 0x000B(0x0021) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PXCC[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStatColorMapping
{
	...
	unsigned char                                      UnknownData_M157[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FStaticMaterial
{
	...
	unsigned char                                      UnknownData_H5XE[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KRQ8[0x54];                                    // 0x0000(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FD1I[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TYLV[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SGCM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7F17[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R1ZF[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J27N[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownData_PXMV[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BXBI[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelVisibilityLevelInfo
{
	...
	unsigned char                                      UnknownData_YUUK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelStreamingLevelStatus
{
	...
	unsigned char                                      UnknownData_86KG[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2CNV[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1C1I[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_L00G[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YODF[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FStreamingRenderAssetPrimitiveInfo
{
	...
	unsigned char                                      UnknownData_WW9A[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurveInstance
{
	...
	unsigned char                                      UnknownData_0DNM[0x2F];                                    // 0x0001(0x002F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JNLV[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GPLN[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelViewportInfo
{
	...
	unsigned char                                      UnknownData_2JJD[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      UnknownData_YPSB[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData_UBLR[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStreamingLevelsToConsider
{
	...
	unsigned char                                      UnknownData_D8Y2[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData_0IW5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6VQ9[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
struct FTireFrictionScalePair
{
	...
	unsigned char                                      UnknownData_ICWY[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FPhysicalSurfaceName
{
	...
	unsigned char                                      UnknownData_P5S1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FBroadphaseSettings
{
	...
	unsigned char                                      UnknownData_UJ8B[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEngineShowFlagsSetting
{
	...
	unsigned char                                      UnknownData_E5XW[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FKeyBind
{
	...
	unsigned char                                      UnknownData_VDV4[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceDelegateResult
{
	...
	unsigned char                                      UnknownData_0C8E[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDebugFloatHistory
{
	...
	unsigned char                                      UnknownData_3OBI[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FUserActivity
{
	...
	unsigned char                                      UnknownData_UDJA[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AVXP[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FInputScaleBiasClamp
{
	...
	unsigned char                                      UnknownData_WT7M[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D9FF[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimationGroupReference
{
	...
	unsigned char                                      UnknownData_41N5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G2YX[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FAnimTickRecord
{
	...
	unsigned char                                      UnknownData_3CHM[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FBlendFilter
{
	unsigned char                                      UnknownData_X5EG[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FBlendSampleData
{
	...
	unsigned char                                      UnknownData_ULRQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4F8C[0x20];                                    // 0x0020(0x0020) MISSED OFFSET (PADDING)
...
struct FAnimationRecordingSettings
{
	...
	unsigned char                                      UnknownData_PY40[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EEIH[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FNamedTransform
{
	...
	struct FName                                       Name;                                                      // 0x0030(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_AQRV[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K153[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FRP7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7ZQQ[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KLLK[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UPTY[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FSlotEvaluationPose
{
	...
	unsigned char                                      UnknownData_2KQS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_88TY[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3AMG[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_Inertialization : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_T065[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N2IT[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z5RD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2DN9[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6GM7[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_CustomProperty : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_G0KT[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
struct FAnimNode_LinkedAnimGraph : public FAnimNode_CustomProperty
{
	...
	unsigned char                                      UnknownData_LWMJ[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EZO1[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_LinkedInputPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_5B3U[0x48];                                    // 0x0030(0x0048) MISSED OFFSET (PADDING)
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_CLXI[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_4JUU[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_BSCU[0x96];                                    // 0x001A(0x0096) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C0EB[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2849[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OMI6[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OW0Y[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NRYY[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B6BQ[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_QFFX[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FDepthFieldGlowInfo
{
	...
	unsigned char                                      UnknownData_MRPS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontRenderInfo
{
	...
	unsigned char                                      UnknownData_N6JN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FComponentReference
{
	...
	unsigned char                                      UnknownData_E8J4[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WN4Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XD12[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WMFX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOverlapResult
{
	...
	unsigned char                                      UnknownData_482D[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GHH9[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSwarmDebugOptions
{
	...
	unsigned char                                      UnknownData_INEZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassDebugOptions
{
	...
	unsigned char                                      UnknownData_AL53[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TYQ4[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FQueuedDrawDebugItem
{
	...
	unsigned char                                      UnknownData_NS52[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QXKM[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData_0AEZ[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               bPlaying;                                                  // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HOP2[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_28WU[0xB8];                                    // 0x0030(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_733A[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LM5G[0x28];                                    // 0x0160(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_80E7[0x24];                                    // 0x018C(0x0024) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyMeshSpaceAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_MJC2[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QT37[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FG71[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (PADDING)
...
struct FPrecomputedSkyLightInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_5CDE[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V4YD[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_N7U8[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D1VF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UTPR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSoundWaveSpectralDataPerSound
{
	...
	unsigned char                                      UnknownData_UYVI[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_IYF8[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSplineInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_2QOP[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSplinePoint
{
	...
	unsigned char                                      UnknownData_ZNK4[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialRemapIndex
{
	...
	unsigned char                                      UnknownData_HFKA[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetEditorOrbitCameraPosition
{
	...
	unsigned char                                      UnknownData_LSM5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedAnimStateArray
{
	...
	unsigned char                                      UnknownData_VIGG[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WSZG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FChildActorComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_DYJE[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownData_F7AO[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_M4J6[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FLevelNameAndTime
{
	...
	unsigned char                                      UnknownData_WNU6[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FLensImperfectionSettings
{
	...
	unsigned char                                      UnknownData_4Y7S[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FLensSettings
{
	...
	unsigned char                                      UnknownData_Q3QK[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FColorGradingSettings
{
	...
	unsigned char                                      UnknownData_QGOO[0x8];                                     // 0x0148(0x0008) MISSED OFFSET (PADDING)
