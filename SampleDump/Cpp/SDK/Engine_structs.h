...
{
	unsigned char                                      UnknownData_G5P6[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O8MM[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NU36[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MNR3[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NN1D[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData_GC3C[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7W9P[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AYC2[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData_7H5I[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0WGD[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FXGN[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSimulatedRootMotionReplicatedMove
{
	...
	unsigned char                                      UnknownData_5OJW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData_AEI2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FWalkableSlopeOverride
{
	...
	unsigned char                                      UnknownData_PPFX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PBWD[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JLF0[0x6];                                     // 0x0000(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P9N8[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z4W4[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_72S7 : 1;                                      // 0x000C(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_SBHZ : 2;                                      // 0x000E(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_ZSXB[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_008C[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_83T9[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F9IU[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L06M[0x40];                                    // 0x00D0(0x0040) MISSED OFFSET (PADDING)
...
struct FSkelMeshComponentLODInfo
{
	...
	unsigned char                                      UnknownData_20UL[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FSingleAnimationPlayData
{
	...
	unsigned char                                      UnknownData_GBY5[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N4WR[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3393[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_J001[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2XW9[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_N1OR[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6CQ5[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K5AT[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KSXG[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TrackIndex;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_QURJ[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData_XEEA[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3VMH[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2A5G[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4QNB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRealCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_POX3[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
struct FRichCurveKey
{
	...
	unsigned char                                      UnknownData_KISZ[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UDIR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RXM6[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8YN0[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBasedMovementInfo
{
	...
	unsigned char                                      UnknownData_EFC5[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
struct FInputAxisKeyMapping
{
	...
	unsigned char                                      UnknownData_U5EI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkinWeightProfileInfo
{
	...
	unsigned char                                      UnknownData_2HZM[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneFilter
{
	...
	unsigned char                                      UnknownData_A9IW[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_Y8I2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R1P7[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R75R[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3Z1E[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODGroupSettings
{
	...
	unsigned char                                      UnknownData_L7XA[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UOCQ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PDIQ[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FRootMotionMovementParams
{
	...
	unsigned char                                      UnknownData_UMNN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J7RW[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LYGA[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XHJF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9CHV[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInstancedStaticMeshComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_JKWP[0x20];                                    // 0x0110(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B6UJ[0xC];                                     // 0x0134(0x000C) MISSED OFFSET (PADDING)
...
struct FIntegralCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_GFT8[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubTrackGroup
{
	...
	unsigned char                                      UnknownData_50CV[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSupportedSubTrackInfo
{
	...
	unsigned char                                      UnknownData_3CNA[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FDrawToRenderTargetContext
{
	...
	unsigned char                                      UnknownData_56XK[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X6NR[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMaterialProxySettings
{
	...
	unsigned char                                      UnknownData_ORBT[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      UnknownData_W8V8[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8P9B[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KJ5P[0x2];                                     // 0x012A(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_09EG[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FDynamicTextureInstance : public FStreamableTextureInstance
{
	...
	unsigned char                                      UnknownData_FIV5[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CQ44[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BC39[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FBatchedPoint
{
	...
	unsigned char                                      UnknownData_W0CU[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FBatchedLine
{
	...
	unsigned char                                      UnknownData_JWYI[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData_HD94[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParameterGroupData
{
	...
	unsigned char                                      UnknownData_Q3ZN[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshVertexColorLODData
{
	...
	unsigned char                                      UnknownData_06JQ[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M42R[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TWQU[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshComponentInstanceData : public FPrimitiveComponentInstanceData
{
	...
	unsigned char                                      UnknownData_83IV[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RWBA[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedStateExitTransition
{
	...
	unsigned char                                      UnknownData_ZPR6[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedAnimationState
{
	...
	unsigned char                                      UnknownData_PKSA[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PGKV[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData_7620[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MGYF[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData_8HO4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKShapeElem
{
	unsigned char                                      UnknownData_VN23[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2U7Z[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I4VQ[0x17];                                    // 0x0019(0x0017) MISSED OFFSET (PADDING)
...
struct FKTaperedCapsuleElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_6LWY[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKBoxElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_7CEZ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKConvexElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_XGN6[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0070(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_F3EU[0x10];                                    // 0x00A0(0x0010) MISSED OFFSET (PADDING)
...
struct FKAggregateGeom
{
	...
	unsigned char                                      UnknownData_3S4Y[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_IF1B[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I1JM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCachedKeyToActionInfo
{
	...
	unsigned char                                      UnknownData_ZLRC[0x68];                                    // 0x0008(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CYCW[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RE0C[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegionBoneFilter
{
	...
	unsigned char                                      UnknownData_GT05[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegion
{
	...
	unsigned char                                      UnknownData_5FIX[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_R787[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData_UA4M[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSH5[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
struct FTireFrictionScalePair
{
	...
	unsigned char                                      UnknownData_ZWUW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAttenuationSubmixSendSettings
{
	...
	unsigned char                                      UnknownData_EJK0[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialParameterInfo
{
	...
	unsigned char                                      UnknownData_MT9W[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontParameterValue
{
	...
	unsigned char                                      UnknownData_CXEH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetRules
{
	...
	unsigned char                                      UnknownData_BJYU[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
	...
	unsigned char                                      UnknownData_GZ19[0x1];                                     // 0x00B3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P3IU[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z80M[0x4];                                     // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActiveForceFeedbackEffect
{
	...
	unsigned char                                      UnknownData_336P[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SY3U[0x17];                                    // 0x0001(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChannelDefinition
{
	...
	unsigned char                                      UnknownData_LG6G[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DAOQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3IE1[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData_TK6K[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_H3U7[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L95E[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      UnknownData_G3KX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedBlendable
{
	...
	unsigned char                                      UnknownData_69IU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      UnknownData_A2L8[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6GFZ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PSIE[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ME01[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4DQZ[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9WTI[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0JPI[0x3];                                     // 0x0315(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M706[0x7];                                     // 0x0319(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TIDA[0x3];                                     // 0x0411(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S4R9[0x3];                                     // 0x043D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QFJ0[0x3];                                     // 0x0459(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RPLX[0x3];                                     // 0x04E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MR8M[0x1];                                     // 0x0507(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HW42[0x2];                                     // 0x0516(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CBTY[0x4];                                     // 0x052C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMinimalViewInfo
{
	...
	unsigned char                                      UnknownData_FWO3[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S6PH[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3953[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4A4Z[0x48];                                    // 0x0588(0x0048) MISSED OFFSET (PADDING)
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData_64PH[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1ER9[0x8];                                     // 0x05E8(0x0008) MISSED OFFSET (PADDING)
...
struct FDebugTextInfo
{
	...
	unsigned char                                      UnknownData_48XJ[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K56F[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4WMN[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_US2Q[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FLightmassMaterialInterfaceSettings
{
	...
	unsigned char                                      UnknownData_XLA4[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_P3W8[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticTerrainLayerWeightParameter : public FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_R37S[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintComponentChangedPropertyInfo
{
	...
	unsigned char                                      UnknownData_CP29[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintCookedComponentInstancingData
{
	...
	unsigned char                                      UnknownData_01TC[0x11];                                    // 0x0010(0x0011) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WQMA[0x26];                                    // 0x0022(0x0026) MISSED OFFSET (PADDING)
...
struct FSoundConcurrencySettings
{
	...
	unsigned char                                      UnknownData_WXKA[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LM7K[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HLI2[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSourceBusSendInfo
{
	...
	unsigned char                                      UnknownData_6ABS[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AE85[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubtitleCue
{
	...
	unsigned char                                      UnknownData_4KDC[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInterpolationParameter
{
	...
	unsigned char                                      UnknownData_GMAX[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	struct FName                                       BoneName;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RHFM[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FBlendParameter
{
	...
	unsigned char                                      UnknownData_PKLZ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1JKL[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2UYK[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C5P5[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FInputAxisProperties
{
	...
	unsigned char                                      UnknownData_6XA5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FFindFloorResult
{
	...
	unsigned char                                      UnknownData_QZAO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCameraCacheEntry
{
	...
	unsigned char                                      UnknownData_EGTA[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCollisionResponseTemplate
{
	...
	unsigned char                                      UnknownData_2HOW[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPHR[0x21];                                    // 0x000B(0x0021) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UHIJ[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDistributionLookupTable
{
	...
	unsigned char                                      UnknownData_TRZY[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FSmartName
{
	...
	unsigned char                                      UnknownData_I8B3[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRigTransformConstraint
{
	...
	unsigned char                                      UnknownData_POV7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNode
{
	...
	unsigned char                                      UnknownData_YH2H[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
struct FQueuedDrawDebugItem
{
	...
	unsigned char                                      UnknownData_YJAI[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HQMO[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAlphaBlend
{
	...
	unsigned char                                      UnknownData_KPO0[0x18];                                    // 0x000C(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GN4M[0xB];                                     // 0x0025(0x000B) MISSED OFFSET (PADDING)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData_E55Q[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               bPlaying;                                                  // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XF0D[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UY7X[0xB8];                                    // 0x0030(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J9BE[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MXKT[0x28];                                    // 0x0160(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GFL2[0x24];                                    // 0x018C(0x0024) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZQ3V[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseLinkBase
{
	...
	unsigned char                                      UnknownData_YKR1[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (PADDING)
...
struct FInputAlphaBoolBlend
{
	...
	unsigned char                                      UnknownData_I859[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputScaleBiasClamp
{
	...
	unsigned char                                      UnknownData_1JAQ[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3RCI[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyMeshSpaceAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_6LH7[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O969[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0JFM[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CustomProperty : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_Q2B0[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
struct FStaticSwitchParameter : public FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_3EGO[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData_CH8Q[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T7YP[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_8ZXP[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownData_JVX2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpControlPoint
{
	...
	unsigned char                                      UnknownData_X8G9[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      UnknownData_7ZWX[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H94J[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FBoolTrackKey
{
	...
	unsigned char                                      UnknownData_M9BH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FStreamingLevelsToConsider
{
	...
	unsigned char                                      UnknownData_HO0U[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BJ8Q[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_4IMP[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RGOL[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FStreamingRenderAssetPrimitiveInfo
{
	...
	unsigned char                                      UnknownData_UFX2[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurveInstance
{
	...
	unsigned char                                      UnknownData_S6K8[0x2F];                                    // 0x0001(0x002F) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OGRC[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NGD8[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelViewportInfo
{
	...
	unsigned char                                      UnknownData_XT9J[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      UnknownData_05ZK[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSubmixSendInfo
{
	...
	unsigned char                                      UnknownData_XSUA[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	float                                              MinSendDistance;                                           // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                              MaxSendDistance;                                           // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FDHI[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeFloatCurve                          CustomSendLevelCurve;                                      // 0x0028(0x0088) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
struct FSoundWaveSpectralTimeData
{
	...
	unsigned char                                      UnknownData_GMAC[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FStatColorMapping
{
	...
	unsigned char                                      UnknownData_DLIL[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FPrimitiveMaterialRef
{
	...
	unsigned char                                      UnknownData_3TR3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData_C9AK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4T0M[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothingAssetData_Legacy
{
	...
	unsigned char                                      UnknownData_E7VS[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FClothPhysicsProperties_Legacy              PhysicsProperties;                                         // 0x001C(0x0050) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_V3R4[0xC];                                     // 0x006C(0x000C) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshClothBuildParams
{
	...
	unsigned char                                      UnknownData_6P50[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W13F[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneMirrorExport
{
	...
	unsigned char                                      UnknownData_412J[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8FAI[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5Z3O[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData_YFMA[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData_SEI8[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimBlueprintFunction
{
	...
	unsigned char                                      UnknownData_8OXL[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XT7A[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_40TP[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimSegment
{
	...
	unsigned char                                      UnknownData_UZ8M[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_WWRF[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBranchingPointMarker
{
	...
	unsigned char                                      UnknownData_JJXB[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurve
{
	...
	unsigned char                                      UnknownData_PHC2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAudioQualitySettings
{
	...
	unsigned char                                      UnknownData_VSZ0[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FReverbSettings
{
	...
	unsigned char                                      UnknownData_4J6A[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteriorSettings
{
	...
	unsigned char                                      UnknownData_TBC4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEditorMapPerformanceTestDefinition
{
	...
	unsigned char                                      UnknownData_1QZN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBandwidthTestGenerator
{
	...
	unsigned char                                      UnknownData_48A8[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FBoneNode
{
	...
	unsigned char                                      UnknownData_RXL8[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OQR5[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMeshUVChannelInfo
{
	...
	unsigned char                                      UnknownData_WBR4[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMaterial
{
	...
	unsigned char                                      UnknownData_YG0K[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FMarkerSyncData
{
	...
	unsigned char                                      UnknownData_5O4W[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimationGroupReference
{
	...
	unsigned char                                      UnknownData_QS8Y[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8F0A[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FAnimTickRecord
{
	...
	unsigned char                                      UnknownData_AZMC[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FBlendFilter
{
	unsigned char                                      UnknownData_QVPP[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FBlendSampleData
{
	...
	unsigned char                                      UnknownData_AYZ0[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YMQQ[0x20];                                    // 0x0020(0x0020) MISSED OFFSET (PADDING)
...
struct FAnimationRecordingSettings
{
	...
	unsigned char                                      UnknownData_Y40G[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M8TC[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FNamedTransform
{
	...
	unsigned char                                      UnknownData_YDDA[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6FP1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RIOJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IVVI[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GVPI[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O4EA[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FSlotEvaluationPose
{
	...
	unsigned char                                      UnknownData_3E81[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_31R8[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      UnknownData_65JS[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QC3E[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X9GS[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNavAgentSelector
{
	...
	unsigned char                                      UnknownData_0QCU[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData_CUBG[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J18X[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IJZ9[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P11Y[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FBeamModifierOptions
{
	...
	unsigned char                                      UnknownData_ZS13[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      UnknownData_N0VJ[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPrimaryAssetRulesCustomOverride
{
	...
	unsigned char                                      UnknownData_6ZDD[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData_S9ZP[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSoundClassProperties
{
	...
	unsigned char                                      UnknownData_QQFJ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UYGB[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D744[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
struct FSourceEffectChainEntry
{
	...
	unsigned char                                      UnknownData_JD68[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FSoundGroup
{
	...
	unsigned char                                      UnknownData_H2BB[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U6RZ[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_6O9G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OP1A[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData_OFDX[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IASK[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FModulatorContinuousParams
{
	...
	unsigned char                                      UnknownData_O00Q[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FEditorImportExportTestDefinition
{
	...
	unsigned char                                      UnknownData_DVVY[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_Inertialization : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_H2AO[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_98OU[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7N8Y[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JGDM[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9TJ0[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_LinkedAnimGraph : public FAnimNode_CustomProperty
{
	...
	unsigned char                                      UnknownData_10GU[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8YS7[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      UnknownData_CW8A[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialCachedExpressionData
{
	...
	unsigned char                                      UnknownData_98PI[0x7];                                     // 0x0221(0x0007) MISSED OFFSET (PADDING)
...
struct FMaterialSpriteElement
{
	...
	unsigned char                                      UnknownData_SFSC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AMUM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZL6B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData_VGDF[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      UnknownData_4FDX[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UYWY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KFC5[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9Z8O[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DMOH[0x28];                                    // 0x0010(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_36XM[0x60];                                    // 0x0040(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMulticastRecordOptions
{
	...
	unsigned char                                      UnknownData_KDY8[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData_WL0R[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDIC[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LYFW[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DRHA[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0FJ7[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphTerminalType
{
	...
	unsigned char                                      UnknownData_5ALM[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData_V0CM[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownData_2CFK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      UnknownData_I8GN[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2F2U[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YJFC[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T7AC[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPY5[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CUUL[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5UPE[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FForceFeedbackChannelDetails
{
	...
	unsigned char                                      UnknownData_F73Y[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHLODProxyMesh
{
	...
	unsigned char                                      UnknownData_II25[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_2909[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       FunctionNameToBind;                                        // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FOrbitOptions
{
	...
	unsigned char                                      UnknownData_MVJ4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData_R7UU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JF3G[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCNA[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGPUSpriteLocalVectorFieldInfo
{
	...
	unsigned char                                      UnknownData_WA1G[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_QWAE[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData_C9AU[0x2];                                     // 0x0146(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AYQS[0x3];                                     // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3N12[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      UnknownData_SROC[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKey                                        Key;                                                       // 0x0010(0x0018) (Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FGPUSpriteEmitterInfo
{
	...
	unsigned char                                      UnknownData_UV2C[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6NYF[0x2];                                     // 0x016A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bEnableCollision : 1;                                      // 0x016C(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WLXE[0x3];                                     // 0x016D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GPUJ[0x3];                                     // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bRemoveHMDRoll : 1;                                        // 0x0174(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WKF2[0x3];                                     // 0x0175(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZCAP[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
struct FEngineShowFlagsSetting
{
	...
	unsigned char                                      UnknownData_CT8Q[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FKeyBind
{
	...
	unsigned char                                      UnknownData_JLCX[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
...
struct FVirtualTextureBuildSettings
{
	...
	unsigned char                                      UnknownData_HDGQ[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FBoneMirrorInfo
{
	...
	unsigned char                                      UnknownData_0AFI[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_JHZ0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      UnknownData_9ULX[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_67SE[0x6];                                     // 0x00B2(0x0006) MISSED OFFSET (PADDING)
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownData_WIRI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FToggleTrackKey
{
	...
	unsigned char                                      UnknownData_0FKX[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FVisibilityTrackKey
{
	...
	unsigned char                                      UnknownData_0EZC[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FLayerActorStats
{
	...
	unsigned char                                      UnknownData_MIDI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1ON4[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_T3II[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPSCPoolElem
{
	...
	unsigned char                                      UnknownData_RNRZ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FPSCPool
{
	...
	unsigned char                                      UnknownData_898Z[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FWorldPSCPool
{
	...
	unsigned char                                      UnknownData_E24A[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FCustomInput
{
	...
	unsigned char                                      UnknownData_8HBI[0x8];                                     // 0x0014(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9J1S[0x54];                                    // 0x0000(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2BGL[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_21FY[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EQ9N[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LOK4[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6E7R[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0ECI[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownData_K050[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4QV3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelVisibilityLevelInfo
{
	...
	unsigned char                                      UnknownData_V3RP[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelStreamingLevelStatus
{
	...
	unsigned char                                      UnknownData_W7WF[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3G2T[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H1Y8[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNodeItem
{
	...
	unsigned char                                      UnknownData_SI95[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
struct FPhysicalAnimationData
{
	...
	unsigned char                                      UnknownData_DNH7[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_4QVK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_O5TD[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FConeConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_LBOU[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FTwistConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_Z0XE[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintDrive
{
	...
	unsigned char                                      UnknownData_9R2R[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearDriveConstraint
{
	...
	unsigned char                                      UnknownData_1TPE[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FAngularDriveConstraint
{
	...
	unsigned char                                      UnknownData_QSXN[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintProfileProperties
{
	...
	unsigned char                                      UnknownData_5SLZ[0x3];                                     // 0x0101(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PWGW[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RDS6[0x7];                                     // 0x0085(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FConstraintProfileProperties                ProfileInstance;                                           // 0x008C(0x0104) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_DAXG[0x28];                                    // 0x0190(0x0028) MISSED OFFSET (PADDING)
...
struct FPhysicalSurfaceName
{
	...
	unsigned char                                      UnknownData_0JJN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FBroadphaseSettings
{
	...
	unsigned char                                      UnknownData_EI6W[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubsurfaceProfileStruct
{
	...
	unsigned char                                      UnknownData_ZSVM[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData_RQLX[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimelineFloatTrack
{
	...
	unsigned char                                      UnknownData_PHG8[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimelineLinearColorTrack
{
	...
	unsigned char                                      UnknownData_CSON[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimeline
{
	...
	unsigned char                                      UnknownData_3MVX[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S2RF[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (PADDING)
...
struct FTTTrackBase
{
	unsigned char                                      UnknownData_WOTL[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_116M[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FVirtualTextureSpacePoolConfig
{
	...
	unsigned char                                      UnknownData_29U4[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData_HOF5[0x1];                                     // 0x009F(0x0001) MISSED OFFSET (PADDING)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData_4USR[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFormatArgumentData
{
	...
	unsigned char                                      UnknownData_KNK9[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EWJY[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3LZS[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData_DQIR[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BEPK[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlatformInterfaceDelegateResult
{
	...
	unsigned char                                      UnknownData_PHRU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDebugFloatHistory
{
	...
	unsigned char                                      UnknownData_SHQ4[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FUserActivity
{
	...
	unsigned char                                      UnknownData_IJVB[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6UG3[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1Y58[0x6E0];                                   // 0x0000(0x06E0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EEP0[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V3GY[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SABW[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDamageEvent
{
	unsigned char                                      UnknownData_RMB9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_LLA0[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YFVC[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseSnapshot
{
	...
	unsigned char                                      UnknownData_Y4LF[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FName                                       Name;                                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_2S81[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData_H3C2[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5AWC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1QPB[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FRootMotionFinishVelocitySettings
{
	...
	unsigned char                                      UnknownData_7ZDK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDepthFieldGlowInfo
{
	...
	unsigned char                                      UnknownData_NUFH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownData_3WNJ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyState
{
	...
	unsigned char                                      UnknownData_UMDJ[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSAS[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FForceFeedbackParameters
{
	...
	unsigned char                                      UnknownData_Y98X[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathResult
{
	...
	unsigned char                                      UnknownData_8E26[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      UnknownData_ZR5U[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PI0V[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QMGQ[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z7FY[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
struct FActiveHapticFeedbackEffect
{
	...
	unsigned char                                      UnknownData_EB9Y[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FImportanceTexture
{
	...
	unsigned char                                      UnknownData_Q5SH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_578Q[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FLensImperfectionSettings
{
	...
	unsigned char                                      UnknownData_KJV2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FConvolutionBloomSettings
{
	...
	unsigned char                                      UnknownData_C45F[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FLensBloomSettings
{
	...
	unsigned char                                      UnknownData_OLZ2[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OBSU[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FLensSettings
{
	...
	unsigned char                                      UnknownData_R7UU[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FSimpleCurve : public FRealCurve
{
	...
	unsigned char                                      UnknownData_8USO[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPrecomputedSkyLightInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_5KX9[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G1H6[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PZDQ[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MG70[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K20D[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSoundWaveSpectralDataPerSound
{
	...
	unsigned char                                      UnknownData_OJ5Z[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WMN6[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSplineInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_C5YH[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSplinePoint
{
	...
	unsigned char                                      UnknownData_8GH6[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialRemapIndex
{
	...
	unsigned char                                      UnknownData_IDSZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetEditorOrbitCameraPosition
{
	...
	unsigned char                                      UnknownData_LECN[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshSectionInfo
{
	...
	unsigned char                                      UnknownData_OWMH[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (PADDING)
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_05WG[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PPB2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      UnknownData_2I9Z[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FStaticMeshSourceModel
{
	...
	unsigned char                                      UnknownData_4HR1[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_LTTG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XKVK[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZMHI[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_LinkedInputPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_SJDW[0x48];                                    // 0x0030(0x0048) MISSED OFFSET (PADDING)
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_PRS2[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_GMNM[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_O490[0x96];                                    // 0x001A(0x0096) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_005O[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JWD0[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BKTW[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4L5C[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PFQL[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7QFQ[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_908X[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FScreenMessageString
{
	...
	unsigned char                                      UnknownData_XSHH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownData_N0OU[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      UnknownData_FVTK[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNamedNetDriver
{
	...
	unsigned char                                      UnknownData_AE3Z[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4F55[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1NI1[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L0YG[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9X76[0x4];                                     // 0x0094(0x0004) Fix Super Size
...
struct FRootMotionSource_RadialForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_LXXM[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AK0V[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TB2M[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_ConstantForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_ZFAO[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCameraExposureSettings
{
	...
	unsigned char                                      UnknownData_CPCU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2E73[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EO0B[0x150];                                   // 0x06E0(0x0150) MISSED OFFSET (PADDING)
...
struct FAnimNode_SingleNode : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_AQZU[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData_P632[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XH7E[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6I5D[0xA8];                                    // 0x00A8(0x00A8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7SUJ[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0EPW[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FEditedDocumentInfo
{
	...
	unsigned char                                      UnknownData_RZ9A[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData_JC7K[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_69IX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCompilerNativizationOptions
{
	...
	unsigned char                                      UnknownData_7XIE[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventGraphFastCallPair
{
	...
	unsigned char                                      UnknownData_27T5[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4Z1B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RHQ1[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0UE2[0x190];                                   // 0x0000(0x0190) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OD2G[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U95N[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_K75J[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LI42[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCachedAnimTransitionData
{
	...
	unsigned char                                      UnknownData_0WZ4[0xC];                                     // 0x0018(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimRelevancyData
{
	...
	unsigned char                                      UnknownData_K04Q[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimAssetPlayerData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_I1UR[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MNFD[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateArray
{
	...
	unsigned char                                      UnknownData_UF50[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DIJP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FChildActorComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_WVAU[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownData_OTGY[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_R3B5[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FLevelNameAndTime
{
	...
	unsigned char                                      UnknownData_JN78[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MLJT[0xD0];                                    // 0x0000(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K0PQ[0x10];                                    // 0x01B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D1FV[0x18];                                    // 0x01D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J4EA[0x50];                                    // 0x0230(0x0050) MISSED OFFSET (PADDING)
...
struct FExposureSettings
{
	...
	unsigned char                                      UnknownData_V0HP[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HKG3[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FFontRenderInfo
{
	...
	unsigned char                                      UnknownData_37CU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FComponentReference
{
	...
	unsigned char                                      UnknownData_BWYM[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QTQE[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A2DU[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6TTS[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOverlapResult
{
	...
	unsigned char                                      UnknownData_7ZOD[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7SOT[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSwarmDebugOptions
{
	...
	unsigned char                                      UnknownData_0T66[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassDebugOptions
{
	...
	unsigned char                                      UnknownData_EIOO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L1OP[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFunctionExpressionInput
{
	...
	unsigned char                                      UnknownData_MN5Y[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (PADDING)
...
struct FScalarParameterAtlasInstanceData
{
	...
	unsigned char                                      UnknownData_0PY2[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData_37X2[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FMeshInstancingSettings
{
	...
	unsigned char                                      UnknownData_6TF8[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_JumpForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_NA8M[0x3];                                     // 0x00AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_68NB[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FRootMotionSource_MoveToDynamicForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_CBAV[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_MoveToForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_97BS[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FColorGradingSettings
{
	...
	unsigned char                                      UnknownData_JIAX[0x8];                                     // 0x0148(0x0008) MISSED OFFSET (PADDING)
