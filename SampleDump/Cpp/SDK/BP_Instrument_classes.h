...
// 0x0098 (FullSize[0x1CC0] - InheritedSize[0x1C28])
...
public:
	...
	unsigned char                                      UnknownData_11FG[0x3];                                     // 0x1C51(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ATW9[0x4];                                     // 0x1C5C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZX8R[0x4];                                     // 0x1C8C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
