...
public:
	...
	class UWidgetAnimation*                            SpinnerAnim;                                               // 0x0240(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_MatchmakingSearchWidget.BP_MatchmakingSearchWidget_C");
		return ptr;
	}
