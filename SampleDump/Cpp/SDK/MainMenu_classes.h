...
public:
	...
	unsigned char                                      UnknownData_PU7T[0x4];                                     // 0x0254(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JB22[0x3];                                     // 0x0279(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9A71[0x4];                                     // 0x0284(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class ABP_RandomProfileDoll_C*                     BP_RandomProfileDoll_507_ExecuteUbergraph_MainMenu_RefProperty; // 0x0288(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_CharacterDoll_C*                         BP_CharacterDoll_2_ExecuteUbergraph_MainMenu_RefProperty;  // 0x0290(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_CharacterDoll_C*                         BP_CharacterDoll2_ExecuteUbergraph_MainMenu_RefProperty;   // 0x0298(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_CharacterDoll_C*                         BP_CharacterDoll3_ExecuteUbergraph_MainMenu_RefProperty;   // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
