...
struct FCameraLookatTrackingSettings
{
	...
	unsigned char                                      UnknownData_0JU1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HP5M[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CQSE[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraTrackingFocusSettings
{
	...
	unsigned char                                      UnknownData_HT7Q[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FNamedFilmbackPreset
{
	...
	unsigned char                                      UnknownData_ONIF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCameraFocusSettings
{
	...
	unsigned char                                      UnknownData_KFB2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_82KY[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3KLU[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XGDU[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
