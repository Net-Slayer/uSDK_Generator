...
public:
	...
	unsigned char                                      UnknownData_PYFR[0xC];                                     // 0x0264(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GUS8[0xC];                                     // 0x02A4(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
