...
// 0x0AE0 (FullSize[0x0B10] - InheritedSize[0x0030])
...
// 0x0490 (FullSize[0x04C0] - InheritedSize[0x0030])
...
public:
	...
	class UPlayFabMultiplayerAPI* STATIC_GetAssetDownloadUrl(const struct FMultiplayerGetAssetDownloadUrlRequest& Request, const struct FScriptDelegate& onSuccess, const struct FScriptDelegate& onFailure, class UObject* customData);
...
public:
	...
	struct FMultiplayerGetAssetDownloadUrlResponse STATIC_decodeGetAssetDownloadUrlResponseResponse(class UPlayFabJsonObject* response);
