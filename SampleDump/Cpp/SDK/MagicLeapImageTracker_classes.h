...
public:
	...
	unsigned char                                      UnknownData_B9CE[0x2];                                     // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AJI5[0x10];                                    // 0x0260(0x0010) MISSED OFFSET (PADDING)
