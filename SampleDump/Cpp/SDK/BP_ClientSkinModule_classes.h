...
{
public:
	unsigned char                                      UnknownData_YD2G[0x8];                                     // 0x04B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_OQAD[0x6];                                     // 0x04EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OG1O[0x7];                                     // 0x0511(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SP4F[0x3];                                     // 0x0521(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
