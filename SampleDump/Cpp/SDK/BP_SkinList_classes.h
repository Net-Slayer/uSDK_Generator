...
// WidgetBlueprintGeneratedClass BP_SkinList.BP_SkinList_C
...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_SkinList.BP_SkinList_C");
		return ptr;
	}



	void AddMessage(const struct FText& Text);
	void Construct();
	void BndEvt__Button_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature();
	void ExecuteUbergraph_BP_SkinList(int EntryPoint);
};
