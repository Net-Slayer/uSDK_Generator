...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_X240[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OZON[0x46];                                    // 0x001A(0x0046) MISSED OFFSET (PADDING)
