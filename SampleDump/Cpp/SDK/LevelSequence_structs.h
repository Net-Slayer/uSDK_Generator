...
{
	unsigned char                                      UnknownData_6PU0[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_C0YV[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_LJTS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_I5SW[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JCBD[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JFKZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_35DJ[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
