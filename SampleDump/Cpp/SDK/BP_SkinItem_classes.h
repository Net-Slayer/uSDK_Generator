...
// WidgetBlueprintGeneratedClass BP_SkinItem.BP_SkinItem_C
// 0x0014 (FullSize[0x0244] - InheritedSize[0x0230])
...
public:
	...
	int                                                ModNumber;                                                 // 0x0240(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_SkinItem.BP_SkinItem_C");
		return ptr;
	}
