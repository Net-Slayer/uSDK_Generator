...
UMG_ESlateVisibility UBP_HomeScreen_C::Get_ToggleNewsButton_Visibility_1()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.Get_ToggleNewsButton_Visibility_1");
...
// Parameters:
//		UMG_ESlateVisibility                               ReturnValue                                                (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
UMG_ESlateVisibility UBP_HomeScreen_C::Get_CloseMenuButton_Visibility_1()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.Get_CloseMenuButton_Visibility_1");
...
// Parameters:
//		UMG_ESlateVisibility                               ReturnValue                                                (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
UMG_ESlateVisibility UBP_HomeScreen_C::GetVisibility_1()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.GetVisibility_1");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.Get_TextBlock_14_Text_1");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.GetCurrentVersionText");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.BndEvt__Button_33_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.BndEvt__leaveButton_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.BndEvt__Button_64_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.BndEvt__HideNewsButton_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.Construct");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.OnItemsRefreshed");
...
void UBP_HomeScreen_C::OnPartyUpdated(TArray<struct FPlayFabPlayer> PartyMembers)
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.OnPartyUpdated");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.UpdatePartyList");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.ToggleNews");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.OnShown");
...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.ExecuteUbergraph_BP_HomeScreen");
