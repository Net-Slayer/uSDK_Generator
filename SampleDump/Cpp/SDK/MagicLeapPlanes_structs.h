...
struct FMagicLeapPlaneResult
{
	...
	unsigned char                                      UnknownData_8RJO[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapPlanesQuery
{
	...
	unsigned char                                      UnknownData_QF7O[0xE];                                     // 0x0052(0x000E) MISSED OFFSET (PADDING)
