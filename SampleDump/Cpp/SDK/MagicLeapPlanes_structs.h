...
struct FMagicLeapPlaneResult
{
	...
	unsigned char                                      UnknownData_Z3UH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapPlanesQuery
{
	...
	unsigned char                                      UnknownData_U7L1[0xE];                                     // 0x0052(0x000E) MISSED OFFSET (PADDING)
