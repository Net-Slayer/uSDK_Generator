...
// Function BP_PlayerMenu.BP_PlayerMenu_C.Get_TextBlock_3_ColorAndOpacity_1
struct UBP_PlayerMenu_C_Get_TextBlock_3_ColorAndOpacity_1_Params
{
	struct FSlateColor                                 ReturnValue;                                               // 0x0000(0x0028)  (Parm, OutParm, ReturnParm)
};

// Function BP_PlayerMenu.BP_PlayerMenu_C.Get_TextBlock_5_Text_1
struct UBP_PlayerMenu_C_Get_TextBlock_5_Text_1_Params
{
	struct FText                                       ReturnValue;                                               // 0x0000(0x0018)  (Parm, OutParm, ReturnParm)
};

// Function BP_PlayerMenu.BP_PlayerMenu_C.Get_TextBlock_3_Text_1
struct UBP_PlayerMenu_C_Get_TextBlock_3_Text_1_Params
{
	struct FText                                       ReturnValue;                                               // 0x0000(0x0018)  (Parm, OutParm, ReturnParm)
};
