...
// Function BP_NavButton.BP_NavButton_C.GetVisibility_3
struct UBP_NavButton_C_GetVisibility_3_Params
{
...
struct UBP_NavButton_C_GetVisibility_2_Params
{
	UMG_ESlateVisibility                               ReturnValue;                                               // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// Function BP_NavButton.BP_NavButton_C.GetVisibility_1
struct UBP_NavButton_C_GetVisibility_1_Params
{
	UMG_ESlateVisibility                               ReturnValue;                                               // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
