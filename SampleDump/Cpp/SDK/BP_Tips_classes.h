...
public:
	...
	class UWidgetAnimation*                            Blink;                                                     // 0x0238(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class URichTextBlock*                              RichTextBlock_1;                                           // 0x0260(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BP_Tips.BP_Tips_C");
		return ptr;
	}



	UMG_ESlateVisibility Get_TeamTip_Visibility_1();
	UMG_ESlateVisibility Get_LoadoutTip_Visibility_1();
	struct FText Get_TeamTip_Text_1();
	struct FText Get_LoadoutTip_Text_1();
	void Show();
	void Construct();
	void WidgetAnimationEvt_Blink_K2Node_WidgetAnimationEvent_1();
