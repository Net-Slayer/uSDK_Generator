...
public:
	...
	unsigned char                                      UnknownData_RITV[0x4];                                     // 0x0204(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AUGZ[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JIQ8[0x18];                                    // 0x0248(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DFFE[0x8];                                     // 0x03F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XTE5[0x5];                                     // 0x0403(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M56B[0x48];                                    // 0x0428(0x0048) MISSED OFFSET (PADDING)
